...
public class PrecioActual extends JFrame {
	...
	classes.Simple simple = new classes.Simple();
	classes.Doble doble= new classes.Doble();
	classes.cHabitual cliente = new classes.cHabitual();
	/**
	...
	public PrecioActual() {
		...
		JLabel lblSimp = new JLabel(""+simple.MostrarPrecio());
		lblSimp.setBounds(199, 55, 111, 14);
		contentPane.add(lblSimp);
		
		JLabel lblSimpdesc = new JLabel(""+(simple.MostrarPrecio()*cHabitual.descuento));
		lblSimpdesc.setBounds(199, 77, 111, 14);
		contentPane.add(lblSimpdesc);
		
		JLabel lblDob = new JLabel(""+doble.MostrarPrecio());
		lblDob.setBounds(199, 102, 111, 14);
		contentPane.add(lblDob);
		
		JLabel lblDobDesc = new JLabel(""+(doble.MostrarPrecio()*cHabitual.descuento));
		lblDobDesc.setBounds(199, 127, 111, 14);
		contentPane.add(lblDobDesc);
		
		JLabel lblMat = new JLabel(""+matri.MostrarPrecio());
		lblMat.setBounds(199, 150, 111, 14);
		contentPane.add(lblMat);
		
		JLabel lblMatdesc = new JLabel(""+(matri.MostrarPrecio()*cHabitual.descuento)); 
